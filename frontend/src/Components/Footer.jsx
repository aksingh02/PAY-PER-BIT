  ...
  return (
    <div className='w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer'>
      ...
      <div className='flex justify-center items-center flex-col mt-5'>
        ...
        <p className='text-white text-sm text-center'>aksingh.aks19@gmail.com</p>
        <p className='text-white text-sm text-center'>mukuthakur4008@gmail.com</p>
      </div>
      <div className='sm:w-[90%] w-full h-[0.25px] bg-gray-400 mt-5'></div>
      <div className='sm:w-[90%] w-full flex justify-between items-center mt-3'>
        

      <p className='text-white text-sm text-center'>@Ankur & Mukund Co. 2022</p>
